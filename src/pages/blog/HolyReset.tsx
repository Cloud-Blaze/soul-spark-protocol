        ...
        <div className="max-w-3xl mx-auto">
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-foreground">
              ...
              <p>This is often referred to as <strong>Type 4</strong> on the <strong>Bristol Stool Chart</strong>, which is considered the <strong>gold standard of healthy digestion</strong>:</p>
              ...
              <ul className="space-y-2 ml-6">
                <li><strong>Ashwagandha + CoQ10</strong> help regulate cortisol and inflammation</li>
                ...
                <li>Your <strong>vagus nerve is rebooting</strong> — and it <em>talks directly to the gut</em></li>
              </ul>
