  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <article className="prose prose-lg max-w-none">
        ...
        <div className="mt-16 text-center">
          <Button 
            onClick={() => window.new = 'https://github.com/Cloud-Blaze/soul-spark-protocol/blob/main/public/Reclaiming%20Life%20from%20the%20Dopamine%20Trap_%20A%20Science-Backed%2090-Day%20Lifestyle%20Reset.pdf'}
